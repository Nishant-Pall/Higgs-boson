...
def del_inavlid_values(set):
    ...
    values are ones with value = -999.
    """
    del_col = []
...
def separate_invalid(set):
    '''
    Splits one data set in two, based on invalid and valid values in column 'DER_mass_MMC'
    '''
...
def get_sets(data):
    '''
    Splits given set(train or test) in four new sets, based on value in column 'PRI_jet_num'
    '''
    ...
    #for train_set_0 where all 'PRI_jet_num' are equal to '0', delete also column 5('DER_pt_h') because 'DER_pt_h' is always equal to 'DER_pt_tot'
    ...
    #for train_set_1 delete column 31('PRI_jet_all_pt') because 'PRI_jet_all_pt' is always equal to 'PRI_jet_leading_pt'
    train_set_1 = np.delete(train_set_1, [24, 31], axis=1)
    #for train_set_2 delete column 31('PRI_jet_all_pt') because 'PRI_jet_all_pt' is always the sum of 'PRI_jet_leading_pt' and 'PRI_jet_subleading_pt'
    #for train_set_2 and train_set_3 delete column 6('DER_deltaeta_jet_jet') because 'DER_deltaeta_jet_jet' is
    #always absolute value of the difference between 'PRI_jet_leading_eta' and 'PRI_jet_subleading_eta'
